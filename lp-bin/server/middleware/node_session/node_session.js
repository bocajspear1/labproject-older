...
function node_session_object()
	{
		...
		function start(request,response,next)
			{
				...
				this.cleanup(run_session,request,response,next);
		...
		function run_session(request,response,next)
			{
					var cookie_value;
		...
		function cleanup(callback,request,response,next)
			{
				console.log("Response: " ,response);
				console.log("Request: " , request);
				var cthis = this;
				this.storage.cleanup(function(){cthis.run_session(request,response,next)});
			}
